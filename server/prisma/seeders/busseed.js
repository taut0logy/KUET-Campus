  ...
  await prisma.meal.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Quinoa, chickpeas, and fresh vegetables",
        nutrition: { calories: 450, protein: 15, carbs: 65, fat: 15 },
        price: 10.99,
        category: "Vegan",
        isVegan: true,
        isGlutenFree: true,
      ...
      },
      {
        ...
        nutrition: { calories: 800, protein: 24, carbs: 88, fat: 26 },
        price: 12.99,
        category: "Pizza",
        isVegan: false,
        isGlutenFree: false,
      ...
      {
        name: "Tofu Stir-Fry",
        description: "Asian-style tofu with vegetables",
        nutrition: { calories: 400, protein: 22, carbs: 45, fat: 18 },
        price: 11.99,
        category: "Asian",
        isVegan: true,
        isGlutenFree: true,
      ...
      },
      {
        ...
        nutrition: { calories: 550, protein: 46, carbs: 15, fat: 32 },
        price: 16.99,
        category: "Seafood",
        isVegan: false,
        isGlutenFree: true,
      ...
      },
      {
        ...
        nutrition: { calories: 480, protein: 18, carbs: 72, fat: 16 },
        price: 11.99,
        category: "Bowls",
        isVegan: true,
        isGlutenFree: true,
      ...
      },
      {
        ...
        description: "Hummus, falafel, and pita bread",
        nutrition: { calories: 680, protein: 22, carbs: 82, fat: 28 },
        price: 13.99,
      ...
      {
        name: "Beef Stir-Fry",
        description: "Tender beef strips with Asian vegetables",
